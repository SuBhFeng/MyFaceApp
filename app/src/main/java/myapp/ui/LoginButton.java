...
public class LoginButton extends View {
    ...
    int bg_color = Color.parseColor("#A9A9A9");
    String btnString = "拍照上传";

    public void setBtnString(String btnString) {
        this.btnString = btnString;
    }

    int rect_to_angle_duration = 50;
    int rect_to_circle_duration = 1;
    private Paint paint;
    ...
    private void setAnimator_arc_to_rotate(){
        ...
        animator_arc_to_rotate.setDuration(500);
    ...
    private void setAnimator_point_move_up(){
        ...
        animator_point_move_up.setDuration(100);
